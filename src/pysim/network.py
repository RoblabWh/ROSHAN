...
class Inputspace(nn.Module):
    ...
    def __init__(self, vision_range, time_steps):
        ...
        layers_dict = [
            {'padding': (0, 0), 'dilation': (1, 1), 'kernel_size': (3, 3), 'stride': (1, 1), 'in_channels': self.time_steps, 'out_channels': 2},
            {'padding': (0, 0), 'dilation': (1, 1), 'kernel_size': (3, 3), 'stride': (1, 1), 'in_channels': 2, 'out_channels': 4},
        ]
