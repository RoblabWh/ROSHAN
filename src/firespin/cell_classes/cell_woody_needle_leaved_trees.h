...
#ifndef ROSHAN_CELL_WOODY_NEEDLE_LEAVED_TREES_H
#define ROSHAN_CELL_WOODY_NEEDLE_LEAVED_TREES_H
...
public:
    ...
    CellWoodyNeedleLeavedTrees() {
        color_ = CellStateColor(CellState::WOODY_NEEDLE_LEAVED_TREES);
        InitMappedColor();
...
#endif //ROSHAN_CELL_WOODY_NEEDLE_LEAVED_TREES_H
