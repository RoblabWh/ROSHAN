...
//
//DroneAgent::DroneAgent(const std::shared_ptr<GridMap>& grid_map, std::string agent_type, FireModelParameters &parameters, int id, int timesteps) :
//                                                                                                id_(id),
...
//}
//
//std::vector<bool> DroneAgent::TerminalFly(bool eval_mode, const std::shared_ptr<GridMap>& grid_map, int total_env_steps) const {
...
//}
//
//std::vector<bool> DroneAgent::TerminalExplore(bool eval_mode, const std::shared_ptr<GridMap> &grid_map, int total_env_steps) {
//    std::vector<bool> terminal_states;
//    bool terminal_state = false;
//    bool drone_died = false;
//    bool drone_succeeded = false;
...
//}
//
//std::vector<bool> DroneAgent::IsTerminal(bool eval_mode, const std::shared_ptr<GridMap>& grid_map, int total_env_steps) {
//    std::vector<bool> terminal_states;
//
//    if (agent_type_ == "FlyAgent") {
